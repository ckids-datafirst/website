...
4. Select the **compare:** dropdown, and click `add-picture-<your-name>`.

   <img alt="screenshot showing both branch selections" src="../images/pull-request-branches.png" />

5. Click **Create pull request**.
6. Enter a title for your pull request. By default, the title will automatically be the name of your branch. For this exercise, let's edit the field to say `Add information about <your name>`.
...
Next, you'll learn how to merge a pull request. [Click here to continue to Step 4.](../step4)
